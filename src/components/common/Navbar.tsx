          ...
          <div className="flex items-center justify-between h-full relative ">
            ...
            <div className="hidden md:flex items-center gap-6 lg:gap-8 flex-1 justify-end">
              ...
              <div className="flex items-center gap-5 ml-2">
                ...
                <Link
                  href="/cart"
                  className={`${textColor} transition-opacity hover:opacity-70 relative`}
                >
                  <ShoppingBag size={19} strokeWidth={1.5} />
                  <span
                    className={`absolute -top-2 -right-3 text-[10px] font-medium ${textColor} bg-black text-white rounded-full px-1 py-0.5`}
                  >
                    {count}
                  </span>
                </Link>
            ...
            <div className="flex items-center gap-3 sm:gap-4 md:hidden">
              ...
              <Link
                href="/cart"
                className={`${textColor} transition-opacity hover:opacity-70 relative p-1`}
              >
                <ShoppingBag size={20} strokeWidth={1.5} />
                <span
                  className={`absolute -top-1 -right-2 text-[10px] font-medium ${textColor} bg-black text-white rounded-full px-1 py-0.5`}
                >
                  {count}
                </span>
              </Link>
        ...
        <div className="min-h-full">
          ...
          <div className="p-4">
            <Link
              ...
              style={{
                background:
                  "linear-gradient(135deg, #8B4513 0%, #B8860B 25%, #DAA520 50%, #FFD700 75%, #FFF8DC 100%)",
                boxShadow:
                  "0 8px 32px rgba(218, 165, 32, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.2)",
              }}
            >
